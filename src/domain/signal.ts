 ...
 * quiet, the other was never there. The controller treats both as "no reading"
 * for demand, but a dashboard showing "—" and a dashboard showing "1100 ppm,
 * 40 minutes ago" are telling you different things.
 */
